...
With in the first stages of the project we came to defince wiche ones where our core classes to start working on. On later stages, the original uml extended based on vertical slicing design to provide more classes taking care of busines logic of our service.
